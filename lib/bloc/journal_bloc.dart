...
class JournalBloc {
  ...
  Future fetchAllJournals() async {
    ...
    _allJournals.add(Journal(fontFamily: noto, content: "他们所有的设备和仪器彷佛都是特别的厉害有生命的。", createdDate: DateTime(2019, 10, 4), id: 99));
    _allJournals.add(Journal(fontFamily: noto, content: "三月春暖花开，东部一大波大学开始放春假，我也不例外，最近开始寻找理想的度假目的地。", createdDate: DateTime(2020, 3, 4), id: 990));
